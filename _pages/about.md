...
저는 **데이터 중심(data-centric) LLM 엔지니어**입니다. 모델의 약점을 드러내는 벤치마크를 만들고, 그 결과를 바탕으로 약점을 메우는 학습 데이터를 직접 설계·구축합니다.

현재 SK텔레콤의 **A.X Foundation Model** 개발에 참여하여, **모델 학습에 사용되는 한국어 Pre-training 데이터와 Post-training 데이터를 직접 설계·구축**하고 있습니다.
