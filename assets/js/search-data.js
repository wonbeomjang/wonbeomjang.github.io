    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-smaller-safer-stronger-sk-telecom-adaptiveml-협업으로-튜닝한-gemma-3-4b-다국어-모더레이션-모델이-google-deepmind-gemmaverse-쇼케이스에-등재되었습니다-프로젝트-리드",
          title: 'Smaller, Safer, Stronger — SK Telecom × AdaptiveML 협업으로 튜닝한 Gemma 3 4B...',
          description: "",
