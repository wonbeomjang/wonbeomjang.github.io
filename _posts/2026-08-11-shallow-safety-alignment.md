...
description: "RL Reward 설계 시리즈 #18 — shallow safety alignment가 prefilling·fine-tuning 공격을 한 번에 설명한다"
categories: [paper]
