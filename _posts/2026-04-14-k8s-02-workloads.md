...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-02-workloads/workload-types.png" class="img-fluid rounded z-depth-1" alt="Kubernetes 워크로드 종류 개요" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-02-workloads/pod-lifecycle.png" class="img-fluid rounded z-depth-1" alt="Pod 생명주기 상태 다이어그램" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-02-workloads/deployment-hierarchy.png" class="img-fluid rounded z-depth-1" alt="Deployment, ReplicaSet, Pod 계층 구조" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-02-workloads/rolling-update.png" class="img-fluid rounded z-depth-1" alt="롤링 업데이트 전략 다이어그램" %}
...
> 다음 글: [K8s 시리즈 03: Service, Ingress — 트래픽 라우팅과 외부 접근](/blog/2026/k8s-03-networking/)
