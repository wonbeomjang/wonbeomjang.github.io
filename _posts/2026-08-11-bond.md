...
description: "RLHF Reward 설계 시리즈 #29 — Best-of-N 분포를 증류해 N배 추론 비용을 없앤다"
categories: [paper]
...
J-BOND는 논문 발표 시점 기준 실제로 **Gemma 1.1(2B, 7B), RecurrentGemma(2B, 9B), CodeGemma 1.1** 정렬에 쓰였다. 이 계보는 [#44 프론티어 모델의 reward 설계](/blog/2026/frontier-reward-design/)에서 다시 짚겠지만, Gemma 계열의 post-training이 WARM류 reward 설계와 BOND·WARP류 정책 최적화를 함께 쌓아 만들어졌다는 사실이 여기서부터 확인된다.
