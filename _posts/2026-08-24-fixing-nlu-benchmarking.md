...
- 평가 데이터셋은 **주석 인공물(annotation artifact)로부터 충분히 자유로워야** 한다 — 시스템이 요구되는 언어 관련 행동을 실제로 보이는 것 외의 다른 방법으로 사람 수준에 가까운 성능에 도달할 수 없어야 한다([Si et al., 2019](https://arxiv.org/abs/1910.12391); [Sugawara et al., 2020b](https://arxiv.org/abs/1911.09241); [Niven and Kao, 2019](https://aclanthology.org/P19-1459/)).
