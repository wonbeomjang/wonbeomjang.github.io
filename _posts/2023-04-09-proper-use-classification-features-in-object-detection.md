...
> [Proper Reuse of Image Classification Features Improves Object Detection](https://arxiv.org/abs/2204.00484) (Vasconcelos et al., Google, CVPR 2022)
...
- FPN, RPN, Detection Cascade 등은 network의 generalization에 도움을 준다.
...
Backbone Freeze가 만병통치약은 아니었다. Freeze시킨 경우에서도 residual adapter를 사용하면 더 좋은 성능을 냈다.
