...
{% include figure.liquid loading="lazy" path="assets/img/triton/01_vector_add/cpu_vs_gpu_parallel.png" class="img-fluid rounded z-depth-1" alt="CPU와 GPU의 병렬 처리 방식 비교" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/01_vector_add/vector_chunking.png" class="img-fluid rounded z-depth-1" alt="벡터를 블록 단위로 분할하는 과정" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/01_vector_add/mask_explanation.png" class="img-fluid rounded z-depth-1" alt="경계 처리를 위한 마스크 동작 설명" %}

---

## 그리드 설정

{% include figure.liquid loading="lazy" path="assets/img/triton/01_vector_add/grid_launch.png" class="img-fluid rounded z-depth-1" alt="그리드 런치 설정 구조" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/01_vector_add/pointer_explanation.png" class="img-fluid rounded z-depth-1" alt="포인터 연산 개념 설명" %}

---

## 벤치마크 결과

{% include figure.liquid loading="lazy" path="assets/img/triton/01_vector_add/benchmark.png" class="img-fluid rounded z-depth-1" alt="벡터 덧셈 성능 벤치마크 결과" %}
