...
제출 2일전에 드디어 완성시키고 그 다음 문서를 작성했다. 주최측에서 [레포지토리](https://github.com/wonbeomjang/AI_APP_WEB_Canary_Canary_2021) [README](https://github.com/wonbeomjang/AI_APP_WEB_Canary_Canary_2021)로 개발문서를 만들라고 해서 README에 문서를 때려 박았다.
