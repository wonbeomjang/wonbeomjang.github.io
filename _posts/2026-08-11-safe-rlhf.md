...
description: "RLHF Reward 설계 시리즈 #15 — helpful과 harmless를 분리하고, 안전성을 최대화가 아닌 제약으로 푼다"
categories: [paper]
...
[#44](/blog/2026/frontier-reward-design/)의 안전성 절에서 봤듯, 이 문제의 실전 함정은 **over-refusal(과잉 거절)** 이다. "거절하면 안전하다"고 단순하게 보상하면, 모델은 무해한 요청까지 거절하는 쪽으로 hacking된다. 안전을 세게 밀수록 도움됨이 무너지는 것이다.
...
[#44](/blog/2026/frontier-reward-design/)에서 본 최신 모델들의 안전 설계가 이 논문의 후예다.
