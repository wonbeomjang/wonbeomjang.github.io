...
[#41](/blog/2026/frontier-reward-design/)의 안전성 절에서 봤듯, 이 문제의 실전 함정은 **over-refusal(과잉 거절)** 이다. "거절하면 안전하다"고 단순하게 보상하면, 모델은 무해한 요청까지 거절하는 쪽으로 hacking된다. 안전을 세게 밀수록 도움됨이 무너지는 것이다.
...
[#41](/blog/2026/frontier-reward-design/)에서 본 최신 모델들의 안전 설계가 이 논문의 후예다.
