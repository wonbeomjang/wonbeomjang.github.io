...
categories: [triton]
tags: [triton, gpu, cuda, deep-learning, optimization]
...
{% include figure.liquid loading="lazy" path="assets/img/triton/00_gpu_basics/cpu_vs_gpu.png" class="img-fluid rounded z-depth-1" alt="CPU와 GPU 구조 비교 다이어그램" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/00_gpu_basics/memory_hierarchy.png" class="img-fluid rounded z-depth-1" alt="GPU 메모리 계층 구조도" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/00_gpu_basics/sm_architecture.png" class="img-fluid rounded z-depth-1" alt="SM(Streaming Multiprocessor) 내부 구조" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/00_gpu_basics/data_types.png" class="img-fluid rounded z-depth-1" alt="GPU 데이터 타입 비교 (FP32, FP16, BF16 등)" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/00_gpu_basics/latency_hiding.png" class="img-fluid rounded z-depth-1" alt="Warp 스케줄링을 통한 지연 숨기기" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/00_gpu_basics/kernel_execution_flow.png" class="img-fluid rounded z-depth-1" alt="커널 실행 흐름 (Grid, Block, Thread)" %}
...
{% include figure.liquid loading="lazy" path="assets/img/triton/00_gpu_basics/roofline_model.png" class="img-fluid rounded z-depth-1" alt="Roofline Model 그래프" %}
