...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-01-intro/vm-vs-container.png" class="img-fluid rounded z-depth-1" alt="VM과 컨테이너 구조 비교" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-01-intro/cluster-architecture.png" class="img-fluid rounded z-depth-1" alt="Kubernetes 클러스터 아키텍처: Control Plane과 Worker Node" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-01-intro/image-build-flow.png" class="img-fluid rounded z-depth-1" alt="컨테이너 이미지 빌드 및 배포 흐름" %}
