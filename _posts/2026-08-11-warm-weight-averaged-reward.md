...
| RL 정책·가치 모델                  | PaLM-XS                                                                        |
| RL 알고리즘                        | 베이스라인을 포함한 REINFORCE (PPO는 [#14](/blog/2026/ppo/)에서 별도로 다룬다) |
...
13. **(현재 글)** WARM (2024) — weight averaging으로 hacking 방어
