...
- $$\{1, \ldots, V\}^{\lvert \mathcal{I} \rvert}$$: 각 위치 토큰은 어휘 1~$$V$$ 중 하나 (V=32000). 접미사가 20개면 $$32000^{20}$$가지 경우의 수.
...
이게 이번 스텝의 "후보 풀"이다. 총 $$k \times \lvert \mathcal{I} \rvert = 2 \times 3 = 6$$개의 (위치, 토큰) 쌍.
