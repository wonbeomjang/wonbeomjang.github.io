...
참고로 이 "정답을 숨겨두고 채점한다"는 발상은 [10편 과최적화 스케일링 법칙](/blog/2026/reward-model-overoptimization/)에서 그대로 재활용된다. 거기서는 사람 대신 gold RM을 정답 자리에 앉히고, 그 라벨로 학습시킨 proxy RM이 언제 무너지는지를 잰다.
