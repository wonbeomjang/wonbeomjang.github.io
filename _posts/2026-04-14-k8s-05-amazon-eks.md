...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-05-amazon-eks/eks-architecture.png" class="img-fluid rounded z-depth-1" alt="EKS 아키텍처: AWS 관리 Control Plane과 사용자 VPC" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-05-amazon-eks/vpc-cni.png" class="img-fluid rounded z-depth-1" alt="VPC CNI: Pod에 VPC IP 직접 할당 구조" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-05-amazon-eks/pod-identity.png" class="img-fluid rounded z-depth-1" alt="EKS Pod Identity: Pod에서 AWS 서비스 접근 흐름" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-05-amazon-eks/cost-formula.png" class="img-fluid rounded z-depth-1" alt="EKS 비용 최적화 공식" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-05-amazon-eks/upgrade-flow.png" class="img-fluid rounded z-depth-1" alt="EKS 클러스터 업그레이드 순서" %}
...
{% include figure.liquid loading="lazy" path="assets/post/image/k8s-05-amazon-eks/deploy-flow.png" class="img-fluid rounded z-depth-1" alt="EKS 배포 파이프라인 흐름" %}
